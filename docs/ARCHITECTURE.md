...
- **This document (`docs/ARCHITECTURE.md`)** stays as the single source of truth for the database architecture and the legacy-to-new schema mapping; feature specs reference it rather than duplicating its content.
